...
/*
class that handles swipe view between g chord variants
 */
public class chord_G_Handler extends FragmentActivity {

    //@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g_handler);

        //initialise view pager and page adaptor
        ViewPager mViewpager = (ViewPager) findViewById(R.id.G_Pager);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            switch (position) {
                case 0:
                    //change to c major
                    return chord_G_Major.newInstance("G Major");
                case 1:
                    return new chord_G_Minor();

                case 2:
                    return new chord_G_Seventh();
