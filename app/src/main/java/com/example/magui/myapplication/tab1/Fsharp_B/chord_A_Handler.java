 ...
 */
/*
class that handles swipe view between a chord variants
 */
public class chord_A_Handler extends FragmentActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.a_handler);

        //initialise view pager and page adaptor
        ViewPager mViewpager = (ViewPager) findViewById(R.id.A_Pager);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            switch (position) {
                case 0:
                    //change to c major
                    return chord_A_Major.newInstance("A Major");
                case 1:
                    return new chord_A_Minor();

                case 2:
                    return new chord_A_Seventh();
